...
CALL sosl_sql_cfg.cmd "@@..\sosl_sql\server\sosl_set_config.sql" "%IDENTIFIER%" "%SOSL_DATETIME%" "SOSL_SERVER_STATE" "INACTIVE" "%SOSL_PATH_LOG%%SOSL_START_LOG%.%SOSL_EXT_LOG%"
...
CALL sosl_sql.cmd "@@..\sosl_sql\server\sosl_stop.sql" "%IDENTIFIER%" "%SOSL_DATETIME%" "%SOSL_PATH_LOG%%SOSL_START_LOG%.%SOSL_EXT_LOG%"
SET SOSL_EXITCODE=%ERRORLEVEL%
IF NOT %SOSL_EXITCODE%==0 (
