...
@ECHO OFF
REM Will cleanup and drop the SOSL schema objects for the user defined with sosl_dba_setup.sql.
REM Get directories
...
CD ..\setup
CHCP 65001 && (TYPE %CUR_SOSL_LOGIN% && ECHO. && ECHO @sosl_cleanup.sql) | sqlplus
CD %CURDIR%