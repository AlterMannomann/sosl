...
AS
  ...
  */
  ...
  /* FUNCTION SOSL_API.HAS_SCRIPTS_FOR_FN
  ...
  */
  ...
  /* FUNCTION SOSL_API.GET_NEXT_SCRIPT
  * This function will be used by the wrapper function GET_NEXT_SCRIPT.
  * It collects all scripts to execute, queues them in SOSL_SCRIPT_QUEUE and then fetches the first script in the
